...
let buftabs = {
    ...
    update: function ()
    {
        ...
        for (let [i, tab] in iter(visibleTabs))
        {
            ...
            dactyl.log("selpos[0]:"+ selpos[0] + " selpos[1]:" + selpos[1],0);
        }
        dactyl.log("-----------------------",0);
        // Scroll
        dactyl.log(selpos[0]+" : "+selpos[1]+"  scroll left before: " + btabs.scrollLeft + " clientWidth:" + btabs.clientWidth,0);
        ...
        dactyl.log("scroll left after: " + btabs.scrollLeft,0);
        dactyl.log("===========================",0);
    },
